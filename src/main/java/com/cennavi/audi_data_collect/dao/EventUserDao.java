	...
	public Object queryHistogram(String cityName, String eventType, String startTime, String endTime,String segmentIdArr, String startTimeFrames, String endTimeFrames) {
		...
		if (!cityName.equals("") && cityName!=null) {
		  ...
		  if (!startTimeFrames.equals("") && startTimeFrames!=null  && !endTimeFrames.equals("") && endTimeFrames!=null ) {
			  sql  += " and date_part('hour',to_timestamp(upload_time,'yyyy-MM-dd hh24:mi:ss'))>="+startTimeFrames+" and date_part('hour',to_timestamp(upload_time,'yyyy-MM-dd hh24:mi:ss'))<="+endTimeFrames+"";
			  sql2  += " and date_part('hour',to_timestamp(upload_time,'yyyy-MM-dd hh24:mi:ss'))>="+startTimeFrames+" and date_part('hour',to_timestamp(upload_time,'yyyy-MM-dd hh24:mi:ss'))<="+endTimeFrames+"";
...
//			   System.err.println(json);
	...
	public Object dataStatistics(String cityName, String eventTypes, String startTime, String endTime, String segmentIds,String startTimeFrames, String endTimeFrames,String sort ) {
		...
		if (!cityName.equals("") && cityName!=null) {
			  ...
			  if (!startTimeFrames.equals("") && startTimeFrames!=null  && !endTimeFrames.equals("") && endTimeFrames!=null ) {
				  sql  += " and date_part('hour',to_timestamp(a.upload_time,'yyyy-MM-dd hh24:mi:ss'))>="+startTimeFrames+" and date_part('hour',to_timestamp(a.upload_time,'yyyy-MM-dd hh24:mi:ss'))<="+endTimeFrames+"";
